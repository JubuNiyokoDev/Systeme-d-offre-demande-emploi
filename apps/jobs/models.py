...
class JobStatus(models.Model):
    ...
    description = models.TextField(
        blank=True, 
        verbose_name="Description du statut"
    )
...
class JobOffer(models.Model):
    ...
    def save(self, *args, **kwargs):
        if self.expires_at < timezone.now():
            expired_status, _ = JobStatus.objects.get_or_create(name='Expired', defaults={'description': 'Statut automatique pour les offres expirées'})
