...
class JobApplicationForm(forms.ModelForm):
    class Meta:
        ...
        labels = {"cover_letter": "Lettre de motivation"}
...
class ApplicationStatusForm(forms.ModelForm):
    class Meta:
        ...
        labels = {"status": "Statut de la candidature", "notes": "Notes internes"}
...
class JobSearchForm(forms.Form):
    ...
    location = forms.CharField(
        ...
        label="Lieu",
        widget=forms.TextInput(
            attrs={"class": "form-control", "placeholder": "Ville, région..."}
        ),
    )
    ...
    min_salary = forms.IntegerField(
        ...
        widget=forms.NumberInput(
            attrs={"class": "form-control", "placeholder": "Salaire minimum"}
        ),
    )
    ...
    max_salary = forms.IntegerField(
        ...
        widget=forms.NumberInput(
            attrs={"class": "form-control", "placeholder": "Salaire maximum"}
        ),
    )
    DATE_CHOICES = [
        ("", "Toutes les dates"),
